...
public interface CuentaComplementariaRepository extends JpaRepository<CuentaComplementaria, String> {
    ...
    Page<CuentaComplementaria> findAllByNumContratoInscripcOrderByNumRenovaciContratoAscNumCuotaNumAsc(String numeroContrato, Pageable pageable);

    Page<CuentaComplementaria> findAllByNumContratoInscripcAndFecVencimiePagoGreaterThanEqualOrderByNumRenovaciContratoAscNumCuotaNumAsc(String numeroContrato, String fecVencimiento, Pageable pageable);

    Page<CuentaComplementaria> findAllByNumContratoInscripcAndCodEstadoAporteOrderByNumRenovaciContratoAscNumCuotaNumAsc(String numeroContrato, String estado, Pageable pageable);
